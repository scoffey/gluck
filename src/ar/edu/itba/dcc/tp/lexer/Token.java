 ...
 * <p>
 * A token has a type, usually bound to an enum, and a value that
 * may be empty for some types and may contain further information for others
 *
 * @param <T> the class of the enumeration of types
 */
public class Token<T> {
	...
	/**
	 * Returns the associated value of the token, or null if no Value is
	 * defined
	 * @return
	 */
