...
import ar.edu.itba.dcc.tp.parser.Parser;
 ...
 * @param args - args[0] should contain the class that implements the lexical analyzer
 *               args[1] should contain the class that implements the parser
 *               args[2] should contain the file to parse
 */
public class Parse {
	...
	private static void info() {
		...
		System.out.println("syntax: Parse <lexer class> <parser class> <file to be parsed>");
	}
}
